            ...
            get
            {
                return new ZDataProfile
                {
                    ...
                    Properties = new List<IZPropertyProfile>
                    {
                        ...
                        new ZPropertyProfile(false, true , 240, true , false, "col-md-4", "LogUserName"),
                        new ZPropertyProfile(false, true , 240, true , false, "col-md-4", "LogDomain"),
                        new ZPropertyProfile(false, true , 240, true , false, "col-md-4", "LogEntity"),
                        new ZPropertyProfile(false, true ,  10, true , false, "col-md-1", "LogOperation"),
                        new ZPropertyProfile(false, true , 240, true , false, "col-md-4", "LogId"),
                        new ZPropertyProfile(false, true , 240, true , false, "col-md-4", "LogEntityBefore"),
                        new ZPropertyProfile(false, true , 240, true , false, "col-md-4", "LogEntityAfter")
                    }
                };
            }
        }
