    ...
    public partial class AuditTrailLog
    {
        ...
        public static IZDataProfile DataProfile { get; private set; } = new ZDataProfile
        {
            ...
            Properties = new List<IZPropertyProfile>
            {
                ...
                new ZPropertyProfile(true , true ,  50, true , false, "col-md-2", "LogOperation"), // !?!
                new ZPropertyProfile(false, true , 100, true , false, "col-md-4", "LogId"), // !?!
                new ZPropertyProfile(false, true , 100, true , false, "col-md-8", "LogEntityBefore"), // !?!
                new ZPropertyProfile(false, true , 100, true , false, "col-md-8", "LogEntityAfter") // !?!
            }
        };
