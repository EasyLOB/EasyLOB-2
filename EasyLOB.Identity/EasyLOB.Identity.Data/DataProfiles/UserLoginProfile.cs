            ...
            get
            {
                return new ZDataProfile
                {
                    ...
                    Properties = new List<IZPropertyProfile>
                    {
                        ...
                        new ZPropertyProfile(true , true , 240, false, false, "col-md-4", "LoginProvider"),
                        new ZPropertyProfile(true , true , 240, false, false, "col-md-4", "ProviderKey"),
                        new ZPropertyProfile(true , true , 240, false, false, "col-md-4", "UserId"),
