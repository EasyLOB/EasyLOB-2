...
namespace EasyLOB.Persistence
{
    ...
    public static partial class AdoNetHelper
    {
        ...
        {
            get { return ConfigurationHelper.AppSettings<string>("AdoNet.SequencePrefix"); }
        }
        ...
        {
            get { return ConfigurationHelper.AppSettings<int>("AdoNet.RecordsBySearch"); }
        }
        ...
        public static string[] GetUserPassword(string connectionName)
        {
            ...
            string cs = ConfigurationHelper.ConnectionStrings(connectionName);
